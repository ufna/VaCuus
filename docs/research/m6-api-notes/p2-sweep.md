...
- Identity = address of a function-local static in an inline member (`Source/ThirdParty/RmlUi/Include/RmlUi/Core/Traits.h:67-91`); the cast compares it through virtual `IsClass` (`:93-105`). Modular flags: `-fvisibility-ms-compat` (`LinuxToolChain.cs:439`), `-fvisibility-inlines-hidden` (`:449`).
